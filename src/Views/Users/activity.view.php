                    ...
                    <?php foreach($weekdays as $weekday): ?>
                        <tr class="font-mono">
                                ...
                                <?php foreach($weekday as $day => $count): ?>
                                    <?php echo "<td><a href='/users/activity.php?userid={$user[0]->id}&date={$count[2]->format('U')}'><div class='w-4 h-4 rounded' style='background-color: {$count[0]}' title='Earned {$count[1]} Achievement" . ($count[1] === 1 ? '' : 's') . " on " . $day . "'></div></a></td>" ?>
                                <?php endforeach; ?>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
